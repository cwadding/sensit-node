...
Report.prototype.list = function (options, callback) {
  ...
  this.client.get('/topics/' + this.topic_id + '/reports', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }
...
Report.prototype.find = function (options, callback) {
  ...
  this.client.get('/topics/' + this.topic_id + '/reports/' + this.id + '', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }
 ...
 */
Report.prototype.create = function (name, query, facets, options, callback) {
  if (typeof options == 'function') {
    callback = options;
    options = {};
  }
  ...
  this.client.post('/topics/' + this.topic_id + '/reports', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }
 ...
 * @param "facets" An array of facet hashes which each contain a `name` ad type of the facet along with its query hash.
 */
Report.prototype.update = function (name, query, facets, options, callback) {
  if (typeof options == 'function') {
    callback = options;
    options = {};
  }
  ...
  this.client.put('/topics/' + this.topic_id + '/reports/' + this.id + '', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }
...
Report.prototype.delete = function (options, callback) {
  ...
  this.client.delete('/topics/' + this.topic_id + '/reports/' + this.id + '', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }

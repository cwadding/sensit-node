...
Field.prototype.list = function (options, callback) {
  ...
  this.client.get('/api/topics/' + this.topic_id + '/fields', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }
...
Field.prototype.find = function (options, callback) {
  ...
  this.client.get('/api/topics/' + this.topic_id + '/fields/' + this.id + '', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }
...
Field.prototype.create = function (field, options, callback) {
  ...
  this.client.post('/api/topics/' + this.topic_id + '/fields', body, options, function(err, response) {
    if (err) {
      return callback(err);
    }

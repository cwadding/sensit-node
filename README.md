...
```js
topic.create("my_topic", "Event data from source A.", options, callback);
```
...
```js
topic.update("my_topic", "Event data from source A.", options, callback);
```
...
```js
feed.create("2013-02-14T16:13:33.378Z", "Eastern Time (US & Canada)", "{"key1":123, "key2":456.2, "city":"alabama"}", options, callback);
```
...
```js
feed.update("Eastern Time (US & Canada)", "{"key1":123, "key2":456.2, "city":"alabama"}", options, callback);
```
...
```js
percolator.create("Eastern Time (US & Canada)", "{"key1":123, "key2":456.2, "city":"alabama"}", options, callback);
```
...
```js
percolator.update("{"key1":123, "key2":456.2, "city":"alabama"}", options, callback);
```
...
```js
report.create("My report", "{"match_all": { }}", "[{"name": "facet1", "type": "terms" ,"query": { "field": "value1"}}]", options, callback);
```
...
```js
report.update("My report", "{"match_all": { }}", "[{"name": "facet1", "type": "terms" ,"query": { "field": "value1"}}]", options, callback);
```
...
```js
subscription.create("alpha", "10.234.12.11", "http", "80", options, callback);
```
...
```js
subscription.update("alpha", "10.234.12.11", "http", "80", options, callback);
```
...
```js
field.create("Transaction ID", "key1", "string", options, callback);
```
...
```js
field.update("Transaction ID", "string", options, callback);
```
